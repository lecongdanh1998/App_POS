...
public class CustomListviewProductsListActivity extends BaseAdapter {

    private Context mContext;
    ArrayList<ContructorProductsList> arrayList;
    LayoutInflater inflater;

    public CustomListviewProductsListActivity(Context mContext, ArrayList<ContructorProductsList> arrayList) {
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.custom_listview_product_list, null);
        ...
        ContructorProductsList library = arrayList.get(i);
        if(arrayList.size() > 0){
