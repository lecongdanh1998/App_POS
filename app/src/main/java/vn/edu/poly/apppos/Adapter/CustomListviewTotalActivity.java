...
public class CustomListviewTotalActivity extends BaseAdapter {

    private Context mContext;
    ArrayList<ContructorCustomerProductsTotal> arrayList;
    LayoutInflater inflater;

    public CustomListviewTotalActivity(Context mContext, ArrayList<ContructorCustomerProductsTotal> arrayList) {
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.custom_listview_customer_products_total, null);
        ...
        ContructorCustomerProductsTotal library = arrayList.get(i);
        if (arrayList.size() > 0) {
